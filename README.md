...
A Thunderbird extension that integrates [Seafile](https://www.seafile.com) as a CloudFile provider. Large email attachments are automatically uploaded to your Seafile server and replaced with download links.
...
- **Auto re-authentication** — expired API tokens are refreshed automatically using stored credentials
...
3. Click **Connect**
4. Select the **target library** for uploads
5. Optionally set an **upload folder** (default: `/Thunderbird-Attachments`)
6. Optionally configure **password protection** and **link expiration**
7. Click **Save**
...
├── background.js              # CloudFile event handlers
├── api/
│   └── seafile.js             # Seafile API client
├── management/
│   ├── management.html        # Account configuration page
│   └── management.js          # Configuration logic
...
- [ ] Save received email attachments to Seafile
